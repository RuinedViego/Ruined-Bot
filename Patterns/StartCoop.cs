...
namespace LeagueBot
{
    public class StartCoop : PatternScript
    {
        private static ChampionEnum[] Champions = new ChampionEnum[]
        {
            ...
            //Always try picking ranged champions they are the best.
            //Easy champs :Annie,Ashe,Twitch,Janna,Olaf,Sona,Sivir,MasterYi,Lux,ect...
            //Normal champs :Senna,Kled,Kindred,Yuumi,Pyke,Sett,Xayah,Rakan,Aphelios,Sylas,Swain,Vi,Nidalee,Lucian,ect...
            //Medium champs :Malphite,Zyra,Aatrox,Diana,Nami,Orianna,Brand,Azir,Katarina,Renekton,Quinn,Syndra,ect...
            //Hard champs : Zed,Yasuo,Rengar,Shen,Urgot,Amumu,Leblanc,Morgana,Anivia,ect...
        };

        private static QueueEnum QueueType = QueueEnum.BotIntermediate; //BotIntro,BotBeginner,BotIntermediate
